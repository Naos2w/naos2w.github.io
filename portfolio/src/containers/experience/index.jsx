...
const Experience = () => {
  ...
  return (
    <section id="experience" className="expr">
      {/* Work Part */}
      <div className="expr_ctn">
        <motion.div
          className="expr_ctn_title"
        ...
        <div className="expr_ctn_wrp">
          <div className="expr_ctn_wrp_textbox">
